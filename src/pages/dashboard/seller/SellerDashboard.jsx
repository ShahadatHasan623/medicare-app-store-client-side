          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[1.618rem] mb-[2rem]">
              <div className="p-[1.618rem] bg-green-50 rounded-2xl shadow-lg text-center">
                ...
                <h3 className="text-lg md:text-xl font-semibold text-[var(--color-text)] mb-[0.618rem] dark:text-gray-700">
                  Paid Total
                </h3>
              ...
              <div className="p-[1.618rem] bg-yellow-50 rounded-2xl shadow-lg text-center">
                ...
                <h3 className="text-lg md:text-xl dark:text-gray-700 font-semibold text-[var(--color-text)] mb-[0.618rem]">
                  Pending Total
                </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="bg-white p-6 rounded-2xl shadow-lg">
                <h3 className="text-xl font-semibold mb-4 text-center dark:text-gray-700">Payments Overview</h3>
                <Pie data={pieData} />
              </div>
